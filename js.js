...
//Function that adds / removes style that highlights name of the current player
...
//this is the last function that activates the pop up and show the winner
...
function checkPositions(){
    ...
    //column4:
        ...
        if(row2[0] == row3[1] && row3[1] == row4[2]){
            console.log('wins');
            ShowWinner()
            return;
        }
        if(row3[0] == row4[1] && row4[1] == row5[2]){
            console.log('wins');
            ShowWinner()
            return;
        }
        if(row3[0] == row2[1] && row2[1] == row1[2]){
            console.log('wins');
            ShowWinner()
            return;
        }
        if(row4[0] == row3[1] && row3[1] == row2[2]){
            console.log('wins');
            ShowWinner()
            return;
        }
        if(row5[0] == row4[1] && row4[1] == row3[2]){
            console.log('wins');
            ShowWinner()
            return;
        }
        //column2:
        if(row1[1] == row3[2] && row3[2] == row4[3]){
            console.log('wins');
            ShowWinner()
            return;
        }
        ...
        if(row3[1] == row4[2] && row4[2] == row5[3]){
            console.log('wins');
            ShowWinner()
            return;
        }
        if(row3[1] == row2[2] && row2[2] == row1[3]){
            console.log('wins');
            ShowWinner()
            return;
        }
        if(row4[1] == row3[2] && row3[2] == row2[3]){
            console.log('wins');
            ShowWinner()
            return;
        }
        if(row5[1] == row4[2] && row4[2] == row3[3]){
            console.log('wins');
            ShowWinner()
            return;
        }
       ...
       //column3:
        ...
        if(row1[2] == row2[3] && row2[3] == row3[4]){
            console.log('wins');
            ShowWinner()
            return;
        }
        if(row2[2] == row3[3] && row3[3] == row4[4]){
            console.log('wins');
            ShowWinner()
            return;
        }
        if(row3[2] == row2[3] && row2[3] == row1[4]){
            console.log('wins');
            ShowWinner()
            return;
        }
        if(row3[2] == row4[3] && row4[3] == row4[4]){
            console.log('wins');
            ShowWinner()
            return;
        }
        if(row4[2] == row3[3] && row3[3] == row2[4]){
            console.log('wins');
            ShowWinner()
            return;
        }
        if(row5[2] == row4[3] && row4[3] == row3[4]){
            console.log('wins');
            ShowWinner()
            return;
        }
